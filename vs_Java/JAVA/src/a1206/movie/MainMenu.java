...
public class MainMenu extends AbstractMenu {
    ...
    public Menu next() {
        switch (scanner.nextLine()) {
            case "1":
                reserve(); // 영화 예매하기
                return this; // 메인 메뉴 객체 반환(다시 메인메뉴가 나온다.)
            case "2":
                checkReservation(); // 영화 예매 확인
                return this;
            case "3":
                cancelReservation(); // 영화 예매 취소
                return this;
            case "4":
                ...
                adminMenu.setPrevMenu(this); // 메인 메뉴를 이전 메뉴로 등록 - this 는 MainMenu를 뜻한다.
    ...
    private void reserve() {
        try {
            ...
            System.out.print("예매할 영화를 선택해 주세요");
            String movieIDStr = scanner.nextLine(); // 예매할 영화 입력
            Movie m = Movie.findById(movieIDStr); // 예매할 영화 찾기
            ...
            r.save();
            System.out.println(seatName + " 좌석의 예매가 완료 되었습니다.");
    ...
    private void checkReservation() {
        System.out.println("발급 번호를 입력해주세요 ");
        try {
            Reservation r = Reservation.findById(scanner.nextLine()); // 예매 확인
            if (r != null) {
                System.err.printf("확인 되었습니다. \n%s ", r.toString());
            } else {
