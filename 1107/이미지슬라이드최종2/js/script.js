...
// ***************** 타이머 함수 *******************************
    ...
    $('#img_slide').mouseenter(function(){
        ...
        //#img_slide에 마우스를 올렸을 때 setInterval기능을 끔.
    });
    $('#img_slide').mouseleave(function(){
        timer();
       //#img_slide에 마우스를 뗐을 때 setInterval이 지정되어있는 timer실행함수를 다시 실행시킴.
    });
...
// ********************** 이전 버튼 ******************************
    ...
    function pressKey(e){
        ...
        // pressKey 함수 내용 (e라는 값에 키보드의 정보를 전부 저장)
        //  A || 왼쪽 화살표 키를 눌렀을 때
        prev_slide();
